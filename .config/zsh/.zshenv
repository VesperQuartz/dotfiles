...
export PATH="/opt/clang-format-static:$GROOVY_BIN:$GOPATH/bin:$GEM:$FLYIO_BIN:$LTEX:$TOMCAT:$P4MERGE:$NODE:$MVN_BIN:$LOCAL_BIN:$STUDIO_HOME:$SCALA_BIN:$ROBO_3T:$YARN_BIN:$PATH"
export PYENV_ROOT="$HOME/.pyenv"
export PATH="$PYENV_ROOT/bin:$PATH"
...
# opencode
export PATH=/home/brown/.opencode/bin:/home/brown/.nub/bin:$PATH
