...
map("n", "<leader>fs", ":FzfLua lsp_document_symbols<CR>", opts)
map("n", "<leader>ft", ":FzfLua lsp_typedefs<CR>", opts)
...
map("n", "<leader>qq", ":FzfLua quickfix<CR>", opts)
map("n", "<leader>fl", ":FzfLua loclist<CR>", opts)
...
map("n", "<leader>fn", ":Noice fzf<CR>", { noremap = true, silent = true })
